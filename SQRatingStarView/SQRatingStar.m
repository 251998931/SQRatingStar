...
-(void)initWithStarCount:(NSUInteger)count
{
    ...
    for (NSUInteger idx = 0; idx < count; ++idx) {
        ...
        star.image = [UIImage imageNamed:@"fen_a"];
        star.highlightedImage = [UIImage imageNamed:@"fen_ina"];
...
{
    __block SQRatingStar *blockSelf = self;
    [self.stars enumerateObjectsUsingBlock:^(id obj, NSUInteger idx, BOOL *stop) {
